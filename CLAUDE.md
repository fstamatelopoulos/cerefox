...
│   ├── mcp-tools/                 # 14 MCP tool handlers shared by remote + local
...
- **Agent guides**: `AGENT_GUIDE.md` (comprehensive reference for AI agents using Cerefox tools), `AGENT_QUICK_REFERENCE.md` (minimal quick reference card -- 14 core tools, key rules, workflows)
