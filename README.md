...
same 14 core tools in-process (plus 4 document-relation tools, hidden until you enable them with `cerefox config set relations_enabled true`) — lower latency, no per-call Edge Function billing, and
