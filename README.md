...
| **Link integrity** | Every write validates `[Text](uuid)` document links and rejects links to nonexistent ids (mangled-UUID protection); examples escape via code formatting; `[[wikilinks]]` may dangle — v1.7.0 |
